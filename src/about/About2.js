      ...
      setActive(!active);
        ...
        return (
         <>
            ...
            <h6 className='text-center text-info mt-4 mb-5' style={{fontFamily:'Century Gothic',lineHeight:"30px"}}>
                "Emploi du temps de la semaine pour <span style={{fontWeight:"bold"}}>{nom[3]}</span>"<br/> 
                Du {nom[0]} jusqu'au {nom[1]}      
            </h6>
